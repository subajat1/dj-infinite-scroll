...
def generate_view_count():
    return random.randint(0, len(authors)*len(categories))
...
class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument('file_name', type=str, help='Txt file contains author journal')
    ...
    def handle(self, *args, **kwargs):
        ...
        with open(file_name+'.txt') as file:
            for row in file:
                ...
                print(title, author_name, category_name, publish_date, views, reviewed)
